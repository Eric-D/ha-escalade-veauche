...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Le=/'/g,Me=/"/g,Ue=/^(?:script|style|textarea|title)$/i,fe=n=>(t,...e)=>({_$litType$:n,strings:t,values:e}),h=fe(1),ss=fe(2),ns=fe(3),y=Symbol.for("lit-noChange"),d=Symbol.for("lit-nothing"),Ne=new WeakMap,$=w.createTreeWalker(w,129);function He(n,t){if(!me(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ce!==void 0?Ce.createHTML(t):t}var wt=(n,t)=>{let e=n.length-1,s=[],r,i=t===2?"<svg>":t===3?"<math>":"",o=H;for(let a=0;a<e;a++){let l=n[a],u,m,p=-1,f=0;for(;f<l.length&&(o.lastIndex=f,m=o.exec(l),m!==null);)f=o.lastIndex,o===H?m[1]==="!--"?o=ke:m[1]!==void 0?o=Re:m[2]!==void 0?(Ue.test(m[2])&&(r=RegExp("</"+m[2],"g")),o=S):m[3]!==void 0&&(o=S):o===S?m[0]===">"?(o=r??H,p=-1):m[1]===void 0?p=-2:(p=o.lastIndex-m[2].length,u=m[1],o=m[3]===void 0?S:m[3]==='"'?Me:Le):o===Me||o===Le?o=S:o===ke||o===Re?o=H:(o=S,r=void 0);let g=o===S&&n[a+1].startsWith("/>")?" ":"";i+=o===H?l+St:p>=0?(s.push(u),l.slice(0,p)+Oe+l.slice(p)+x+g):l+x+(p===-2?a:g)}return[He(n,i+(n[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),s]},I=class n{constructor({strings:t,_$litType$:e},s){let r;this.parts=[];let i=0,o=0,a=t.length-1,l=this.parts,[u,m]=wt(t,e);if(this.el=n.createElement(u,s),$.currentNode=this.el.content,e===2||e===3){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(r=$.nextNode())!==null&&l.length<a;){if(r.nodeType===1){if(r.hasAttributes())for(let p of r.getAttributeNames())if(p.endsWith(Oe)){let f=m[o++],g=r.getAttribute(p).split(x),T=/([.?@])?(.*)/.exec(f);l.push({type:1,index:i,name:T[2],strings:g,ctor:T[1]==="."?de:T[1]==="?"?ue:T[1]==="@"?pe:R}),r.removeAttribute(p)}else p.startsWith(x)&&(l.push({type:6,index:i}),r.removeAttribute(p));if(Ue.test(r.tagName)){let p=r.textContent.split(x),f=p.length-1;if(f>0){r.textContent=G?G.emptyScript:"";for(let g=0;g<f;g++)r.append(p[g],j()),$.nextNode(),l.push({type:2,index:++i});r.append(p[f],j())}}}else if(r.nodeType===8)if(r.data===De)l.push({type:2,index:i});else{let p=-1;for(;(p=r.data.indexOf(x,p+1))!==-1;)l.push({type:7,index:i}),p+=x.length-1}i++}}static createElement(t,e){let s=w.createElement("template");return s.innerHTML=t,s}};function k(n,t,e=n,s){if(t===y)return t;let r=s!==void 0?e._$Co?.[s]:e._$Cl,i=z(t)?void 0:t._$litDirective$;return r?.constructor!==i&&(r?._$AO?.(!1),i===void 0?r=void 0:(r=new i(n),r._$AT(n,e,s)),s!==void 0?(e._$Co??(e._$Co=[]))[s]=r:e._$Cl=r),r!==void 0&&(t=k(n,r._$AS(n,t.values),r,s)),t}var ce=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:s}=this._$AD,r=(t?.creationScope??w).importNode(e,!0);$.currentNode=r;let i=$.nextNode(),o=0,a=0,l=s[0];for(;l!==void 0;){if(o===l.index){let u;l.type===2?u=new q(i,i.nextSibling,this,t):l.type===1?u=new l.ctor(i,l.name,l.strings,this,t):l.type===6&&(u=new he(i,this,t)),this._$AV.push(u),l=s[++a]}o!==l?.index&&(i=$.nextNode(),o++)}return $.currentNode=w,r}p(t){let e=0;for(let s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}},q=class n{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,s,r){this.type=2,this._$AH=d,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=k(this,t,e),z(t)?t===d||t==null||t===""?(this._$AH!==d&&this._$AR(),this._$AH=d):t!==this._$AH&&t!==y&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):$t(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==d&&z(this._$AH)?this._$AA.nextSibling.data=t:this.T(w.createTextNode(t)),this._$AH=t}$(t){let{values:e,_$litType$:s}=t,r=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=I.createElement(He(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===r)this._$AH.p(e);else{let i=new ce(r,this),o=i.u(this.options);i.p(e),this.T(o),this._$AH=i}}_$AC(t){let e=Ne.get(t.strings);return e===void 0&&Ne.set(t.strings,e=new I(t)),e}k(t){me(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,s,r=0;for(let i of t)r===e.length?e.push(s=new n(this.O(j()),this.O(j()),this,this.options)):s=e[r],s._$AI(i),r++;r<e.length&&(this._$AR(s&&s._$AB.nextSibling,r),e.length=r)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){let s=Te(t).nextSibling;Te(t).remove(),t=s}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},R=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,r,i){this.type=1,this._$AH=d,this._$AN=void 0,this.element=t,this.name=e,this._$AM=r,this.options=i,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=d}_$AI(t,e=this,s,r){let i=this.strings,o=!1;if(i===void 0)t=k(this,t,e,0),o=!z(t)||t!==this._$AH&&t!==y,o&&(this._$AH=t);else{let a=t,l,u;for(t=i[0],l=0;l<i.length-1;l++)u=k(this,a[s+l],e,l),u===y&&(u=this._$AH[l]),o||(o=!z(u)||u!==this._$AH[l]),u===d?t=d:t!==d&&(t+=(u??"")+i[l+1]),this._$AH[l]=u}o&&!r&&this.j(t)}j(t){t===d?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},de=class extends R{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===d?void 0:t}},ue=class extends R{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==d)}},pe=class extends R{constructor(t,e,s,r,i){super(t,e,s,r,i),this.type=5}_$AI(t,e=this){if((t=k(this,t,e,0)??d)===y)return;let s=this._$AH,r=t===d&&s!==d||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,i=t!==d&&(s===d||r);r&&this.element.removeEventListener(this.name,this,s),i&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},he=class{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){k(this,t)}};var At=P.litHtmlPolyfillSupport;At?.(I,q),(P.litHtmlVersions??(P.litHtmlVersions=[])).push("3.3.3");var Pe=(n,t,e)=>{let s=e?.renderBefore??t,r=s._$litPart$;if(r===void 0){let i=e?.renderBefore??null;s._$litPart$=r=new q(t.insertBefore(j(),i),i,void 0,e??{})}return r._$AI(n),r};var B=globalThis,_=class extends b{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;let t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Pe(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return y}};_._$litElement$=!0,_.finalized=!0,B.litElementHydrateSupport?.({LitElement:_});var Et=B.litElementPolyfillSupport;Et?.({LitElement:_});(B.litElementVersions??(B.litElementVersions=[])).push("4.2.2");var Tt={attribute:!0,type:String,converter:U,reflect:!1,hasChanged:Y},Ct=(n=Tt,t,e)=>{let{kind:s,metadata:r}=e,i=globalThis.litPropertyMetadata.get(r);if(i===void 0&&globalThis.litPropertyMetadata.set(r,i=new Map),s==="setter"&&((n=Object.create(n)).wrapped=!0),i.set(e.name,n),s==="accessor"){let{name:o}=e;return{set(a){let l=t.get.call(this);t.set.call(this,a),this.requestUpdate(o,l,n,!0,a)},init(a){return a!==void 0&&this.C(o,void 0,n,a),a}}}if(s==="setter"){let{name:o}=e;return function(a){let l=this[o];t.call(this,a),this.requestUpdate(o,l,n,!0,a)}}throw Error("Unsupported decorator location: "+s)};function L(n){return(t,e)=>typeof e=="object"?Ct(n,t,e):((s,r,i)=>{let o=r.hasOwnProperty(i);return r.constructor.createProperty(i,s),o?Object.getOwnPropertyDescriptor(r,i):void 0})(n,t,e)}function J(n){return L({...n,state:!0,attribute:!1})}var F=["open","closed","unknown"],je={ouvert:"open",ferme:"closed",ferm\u00E9:"closed",inconnu:"unknown"},Z=[0,1,2,3,4,5,6],ze=["Lundi","Mardi","Mercredi","Jeudi","Vendredi","Samedi","Dimanche"],ge=["list","tiles"],Ie={liste:"list",tuiles:"tiles"};var kt={open:"var(--success-color)",closed:"var(--error-color)",unknown:"var(--primary-color)"};function qe(n){if(n==null||n==="")return;if(Array.isArray(n)){if(n.length!==3)return;let e=n.map(Number);return e.some(s=>!Number.isInteger(s)||s<0||s>255)?void 0:`rgb(${e[0]}, ${e[1]}, ${e[2]})`}if(typeof n!="string")return;let t=n.trim();if(!(t===""||t.length>120||/[;{}<>]/.test(t)))return t}function Be(n,t){return(n==="open"?t.open:n==="closed"?t.closed:void 0)??kt[n]}var Q=.88;function Fe(n){if(n==null||n==="")return;let t=Number(n);if(!(!Number.isFinite(t)||t<0||t>1))return t}function Ve({background:n,overlay:t,intensity:e}){return[n?`background-image:url("${n}")`:"",`--esc-overlay:${t}`,`--esc-intensity:${e}`].filter(Boolean).join(";")}function ee(n){return n.open===!0?"open":n.open===!1?"closed":"unknown"}function We(n){return n==="open"?{color:"#1b5e20",bg:"#c8e6c9"}:n==="closed"?{color:"#b71c1c",bg:"#ffcdd2"}:{color:"#37474f",bg:"#cfd8dc"}}function Ke(n){return n==="open"?"Ouvert":n==="closed"?"Ferm\xE9":"Statut inconnu"}function Ye(n){return typeof n!="number"||!Number.isFinite(n)?{type:"unknown",text:"date inconnue"}:n<0?{type:"unknown",text:"cr\xE9neau pass\xE9"}:n===0?{type:"today",text:"aujourd'hui"}:n===1?{type:"tomorrow",text:"demain"}:n<=7?{type:"soon",text:`dans ${n} jours`}:{type:"later",text:`dans ${n} jours`}}var Rt="0.5.0";function Ge(){console.info(`%c ESCALADE-CARD %c ${Rt} IS INSTALLED `,"color: white; background: #1565c0; font-weight: bold;","color: #1565c0; background: #bbdefb; font-weight: bold;")}function c(n,t,e,...s){let r=`%c ESCALADE-CARD %c [${t}]`,i=["color: white; background: #1565c0; font-weight: bold;","color: #1565c0; font-weight: bold;"];console[n](r+" "+e,...i,...s)}var Je=10,Lt=2e3,Mt=15e3,te=class{constructor(t,e){this.cardName=t;this.fire=e;this.timer=null;this.count=0}schedule(){if(this.timer||(this.count++,this.count>Je))return;let t=Math.min(Lt*this.count,Mt);c("info",this.cardName,"Retry %d dans %dms\u2026",this.count,t),this.timer=setTimeout(()=>{this.timer=null,this.fire()},t)}get exhausted(){return this.count>Je}reset(){this.count=0,this.cancel()}cancel(){this.timer&&(clearTimeout(this.timer),this.timer=null)}};var Xe=["lun.","mar.","mer.","jeu.","ven.","sam.","dim."],Nt=["lundi","mardi","mercredi","jeudi","vendredi","samedi","dimanche"],Ze=["janv.","f\xE9vr.","mars","avr.","mai","juin","juil.","ao\xFBt","sept.","oct.","nov.","d\xE9c."],Ot=["janvier","f\xE9vrier","mars","avril","mai","juin","juillet","ao\xFBt","septembre","octobre","novembre","d\xE9cembre"],Dt=/(\d{1,2})\s*h\s*(\d{2})?\s*[-–—]\s*(\d{1,2})\s*h\s*(\d{2})?/;function Ut(n){if(typeof n!="string")return null;let t=Dt.exec(n);if(!t)return null;let e=Number(t[1]),s=Number(t[2]??"0"),r=Number(t[3]),i=Number(t[4]??"0");if(e>23||r>23||s>59||i>59)return null;let o=e*60+s,a=r*60+i;return a<=o?null:{start:o,end:a}}function _e(n){if(!n)return null;let t=e=>{let s=Math.floor(e/60),r=e%60;return r===0?`${s}h`:`${s}h${String(r).padStart(2,"0")}`};return`${t(n.start)} \u2013 ${t(n.end)}`}function ye(n,t=0){let e=/^(\d{4})-(\d{2})-(\d{2})$/.exec(n);if(!e)return null;let s=new Date(Number(e[1]),Number(e[2])-1,Number(e[3]),Math.floor(t/60),t%60,0,0);return Number.isNaN(s.getTime())?null:s}function Ht(n,t){let e=new Date(n.getFullYear(),n.getMonth(),n.getDate(),12),s=new Date(t.getFullYear(),t.getMonth(),t.getDate(),12);return Math.round((s.getTime()-e.getTime())/864e5)}function Qe(n){return n.isNow?"en cours":n.daysUntil===null?"":n.daysUntil===0?"aujourd'hui":n.daysUntil===1?"demain":`dans ${n.daysUntil} j`}function Pt(n,t){if(typeof n.date!="string")return null;let e=ye(n.date);if(!e)return null;let s=Ut(n.horaire),r=s?ye(n.date,s.start):e,i=s?ye(n.date,s.end):null;if(!r)return null;let o=Ht(t,e);return{date:n.date,weekday:n.weekday,dayOfMonth:e.getDate(),month:e.getMonth(),start:r,end:i,range:s,status:n.open===!0?"open":n.open===!1?"closed":"unknown",statut:n.statut,daysUntil:o,isToday:o===0,isNow:i!==null&&r<=t&&t<i}}function et(n,t,e){let s=[];for(let r of n){let i=Pt(r,t);if(i){if(i.end!==null){if(i.end<=t)continue}else if(i.daysUntil!==null&&i.daysUntil<0)continue;s.push(i)}}return s.sort((r,i)=>r.start.getTime()-i.start.getTime()),s.slice(0,Math.max(0,e))}function tt(n){let t=Nt[n.weekday]??"",e=Ot[n.month]??"",s=`${t} ${n.dayOfMonth} ${e}`.trim(),r=_e(n.range);return r?`${s}, ${r}`:s}function be({title:n,message:t="Chargement\u2026"}){return h`
  ...
  `}var jt=720*60*1e3;function st(n){if(n.fetch_ok!==!1)return d;let t=n.last_success?new Date(n.last_success):null,e=t?.getTime();if(e!==void 0&&!Number.isNaN(e)&&Date.now()-e<jt)return d;let s=e===void 0||Number.isNaN(e)?"date inconnue":t.toLocaleString("fr-FR",{dateStyle:"short",timeStyle:"short"});return h`
  ...
  `}var se={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},ne=n=>(...t)=>({_$litDirective$:n,values:t}),M=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,s){this._$Ct=t,this._$AM=e,this._$Ci=s}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};var rt="important",zt=" !"+rt,ve=ne(class extends M{constructor(n){if(super(n),n.type!==se.ATTRIBUTE||n.name!=="style"||n.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(n){return Object.keys(n).reduce((t,e)=>{let s=n[e];return s==null?t:t+`${e=e.includes("-")?e:e.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(n,[t]){let{style:e}=n.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let s of this.ft)t[s]==null&&(this.ft.delete(s),s.includes("-")?e.removeProperty(s):e[s]=null);for(let s in t){let r=t[s];if(r!=null){this.ft.add(s);let i=typeof r=="string"&&r.endsWith(zt);s.includes("-")||i?e.setProperty(s,i?r.slice(0,-11):r,i?rt:""):e[s]=r}}return y}});function it({slot:n}){let t=ee(n),e=We(t),s=Ye(n.days_left);return h`
  ...
  `}function at({sessions:n,columns:t,showTime:e,showCountdown:s,showStatus:r,accents:i}){return h`
    <div class="esc-tiles" style="--esc-columns:${t}">
      ${n.map(o=>qt({session:o,showTime:e,showCountdown:s,showStatus:r,accents:i}))}
    </div>
  `}function lt(n){return h`<div class="esc-tiles-title">${n}</div>`}function xe(n){return h`<div class="esc-tiles-empty">${n}</div>`}var ct=O`
  :host {
    display: block;
  }
  .escalade-header {
...
`;var Bt={open:"Cr\xE9neaux ouverts",closed:"Cr\xE9neaux ferm\xE9s",unknown:"Statut non reconnu"},Ft={entity:"Entit\xE9 (sensor)",mode:"Mode d'affichage",title:"Titre personnalis\xE9",show_title:"Afficher le titre (mode tuiles)",days:"Jours affich\xE9s",statuses:"Statuts affich\xE9s",max:"Nombre maximal de cr\xE9neaux (mode liste)",count:"Nombre de tuiles (mode tuiles)",show_time:"Afficher l'horaire",show_countdown:"Afficher le d\xE9lai",show_status:"Afficher le statut",background:"Photo de fond (mode tuiles)",overlay:"Opacit\xE9 du voile",accent_open:"Couleur des cr\xE9neaux ouverts",accent_closed:"Couleur des cr\xE9neaux ferm\xE9s",accent_intensity:"Intensit\xE9 de la teinte"},Vt=[{name:"entity",required:!0,selector:{entity:{domain:"sensor",integration:"escalade_veauche"}}},{name:"mode",selector:{select:{mode:"dropdown",options:[{value:"list",label:"Liste (une ligne par cr\xE9neau)"},{value:"tiles",label:"Tuiles calendrier (compact)"}]}}},{name:"title",selector:{text:{}}},{name:"days",selector:{select:{multiple:!0,mode:"list",options:Z.map(n=>({value:String(n),label:ze[n]??String(n)}))}}},{name:"statuses",selector:{select:{multiple:!0,options:F.map(n=>({value:n,label:Bt[n]??n}))}}},{name:"max",selector:{number:{min:1,max:60,mode:"box"}}},{name:"count",selector:{number:{min:1,max:4,mode:"box"}}},{name:"show_title",selector:{boolean:{}}},{name:"show_time",selector:{boolean:{}}},{name:"show_countdown",selector:{boolean:{}}},{name:"show_status",selector:{boolean:{}}},{name:"background",selector:{text:{}}},{name:"overlay",selector:{number:{min:0,max:1,step:.05,mode:"slider"}}},{name:"accent_open",selector:{color_rgb:{}}},{name:"accent_closed",selector:{color_rgb:{}}},{name:"accent_intensity",selector:{number:{min:0,max:1,step:.05,mode:"slider"}}}],Wt=n=>Ft[n.name]??n.name,V=class extends _{constructor(){super(...arguments);this._config={entity:""}}setConfig(e){this._config=e??{entity:""}}createRenderRoot(){return this}render(){if(!this.hass)return h``;let e={...this._config,days:this._config.days?.map(String)};return h`
      <ha-form
        .hass=${this.hass}
        .data=${e}
        .schema=${Vt}
    ...
    `}_tilesShell(e,s){let r=this._config,i=r?.background,a=(r?.tap_action?.action??"more-info")!=="none",l=Ve({background:i,overlay:r?.overlay??.35,intensity:r?.accent_intensity??Q}),u=this._tilesTitle(),m=s?`Escalade : prochaine s\xE9ance ${tt(s)}`:"Escalade : cr\xE9neaux";return h`
      <ha-card
    ...
    `}_renderTilesMode(e){let s=e.attributes??{},r=Array.isArray(s.creneaux)?s.creneaux:[],i=this._config?.count??3,o=et(this._visibleSlots(r),new Date,i),a=o.length===0?xe("Aucune s\xE9ance \xE0 venir"):at({sessions:o,columns:i,showTime:this._config?.show_time===!0,showCountdown:this._config?.show_countdown===!0,showStatus:this._config?.show_status===!0,accents:{open:this._config?.accent_open,closed:this._config?.accent_closed}});return this._tilesShell(a,o[0]??null)}};A.styles=[ct,dt],A._instances=0,C([L({attribute:!1})],A.prototype,"hass",1),C([J()],A.prototype,"_config",2);var re=A;Ge();window.loadCardHelpers?.().catch(n=>{c("warn","card","loadCardHelpers() a \xE9chou\xE9 : %o",n)});var E="escalade-card",Yt=5,ut=0;function Gt(){if(customElements.get(E)||ut>=Yt)return!1;ut++;try{return customElements.define(E,class extends re{}),c("warn","card","r\xE9-enregistr\xE9 \xE0 t=%dms : le registre d'\xE9l\xE9ments personnalis\xE9s avait \xE9t\xE9 remplac\xE9 depuis le premier enregistrement",Math.round(performance.now())),!0}catch(n){return c("error","card","r\xE9-enregistrement impossible : %o",n),!1}}customElements.get(E)?c("info","card","module d\xE9j\xE0 enregistr\xE9, ce chargement est ignor\xE9"):(customElements.define(E,re),c("info","card","\xE9l\xE9ment enregistr\xE9 \xE0 t=%dms apr\xE8s le d\xE9but du chargement de la page",Math.round(performance.now())));function Jt(){let n=0,t=e=>{if(e.localName==="hui-error-card"){let s=e;((s._config??s.config)?.message??"").includes(E)&&(e.dispatchEvent(new CustomEvent("ll-rebuild",{bubbles:!0,composed:!0})),n++);return}for(let s of[...e.shadowRoot?.children??[],...e.children])t(s)};return document.body&&t(document.body),n}for(let n of[0,50,150,400,1e3,2e3,4e3])window.setTimeout(()=>{try{Gt();let t=Jt();t>0&&c("warn","card","%d carte(s) d'erreur reconstruite(s) apr\xE8s %dms \u2014 la vue a \xE9t\xE9 b\xE2tie avant l'enregistrement de l'\xE9l\xE9ment",t,n)}catch(t){c("error","card","r\xE9paration des cartes d'erreur impossible : %o",t)}},n);window.customCards=window.customCards??[];window.customCards.some(n=>n.type===E)||window.customCards.push({type:E,name:"Escalade Veauche",description:"Affiche les cr\xE9neaux d'ouverture des Cimes Veauchoises"});export{re as EscaladeCard};
